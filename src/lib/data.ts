...
export const mockKras: KRA[] = [
  {
    ...
    actions: [
      { id: uuidv4(), name: 'Finalize UI mockups', dueDate: new Date('2024-07-15'), isCompleted: true },
      { id: uuidv4(), name: 'Develop backend APIs', dueDate: new Date('2024-08-10'), isCompleted: true },
      { id: uuidv4(), name: 'Frontend implementation', dueDate: new Date('2024-09-01'), isCompleted: false },
    ],
  ...
  {
    id: 'KRA-009',
    taskDescription: 'Conduct weekly team performance reviews.',
    employee: {
      id: 'EMP-008',
      name: 'Prakash Joshi',
